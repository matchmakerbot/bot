...
const execute = async (message) => {
    ...
    switch (args(message)) {
        ...
        case "status": {
            ...
            wrongEmbed.addField(`Players:`, `<@${teamsArray[0][1]}>, <@${teamsArray[0][2]}>, <@${teamsArray[0][3]}>`);
        ...
        case "score": {
            switch (secondArg) {
                ...
                case "channel": {
                    ...
                    findGuildTeams = findGuildTeams.filter(a => a.channels.map(e => e.channelID).indexOf(thirdArg) !== -1 && a.channels[a.channels.map(e => e.channelID).indexOf(thirdArg)].wins + a.channels[a.channels.map(e => e.channelID).indexOf(thirdArg)].losses !== 0)
                        ...
                        for (indexes; indexes < 20 * fourthArg; indexes++) {
                            ...
                            for (let channels of findGuildTeams[indexes].channels) {
                                if (channels.channelID === thirdArg) {
                                    ...
                                    correctEmbed.setFooter(`Showing page ${fourthArg}/${Math.ceil(findGuildTeams.length / 20)}`);
                                }
                            }
                        }
                    } else {
        ...
        case "q": {
            ...
            if (teamsInfo().members.length < 3) {
                ...
                wrongEmbed.setTitle(":x: You need at least 3 members on your team to join the queue");
...
module.exports = {
    name: ['q', "status", "leave", "report", "score", "cancel", "reset", "game", "ongoinggames", "createteam", "invite", "disband", "jointeam", "pendinginvites", "leaveteam", "whois", "kickplayer", "mode"],
