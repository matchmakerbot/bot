...
const discordEmbed = new Discord.RichEmbed()
    ...
    .addField("!c", 'Vote for captains mode. First captain types the number of the player that he wants, Second captain types the two numbers in different lines of the players that he wants, and so on.')
