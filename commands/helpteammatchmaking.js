...
const discordEmbed = new Discord.MessageEmbed()
    ...
    .setColor('#F8534F')
    .setTitle("For solos matchmaking help, please type !helpmatchmaking")
    .addField("!createteam", "Creates a team, usage: !createteam Maniacs")
    ...
    .addField("!q", 'Sign up for the next queue, to do this do !q and tag your 4 other teammates(2 if your channelmode is 3v3teams) example: !q @Dany @Johny @Tony @David (removes player after 45 minutes if no game has been made)')
    ...
    .addField("Commands to be added:", "!giveownership: gives team ownership to a player. | !revertgame: allows an admin to revert or cancel a game that has been incorrectly reported as a win/lose.")
